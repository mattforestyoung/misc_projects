...
This is not my code, it is copied from https://github.com/ShakaUVM/colors/tree/master

I have used this just to read keyboard input in a non-blocking way for the 
purposes of this coding challenge. Add credit/rights to the original author etc
